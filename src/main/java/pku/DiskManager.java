...
public class DiskManager {
    ...
    public static synchronized void writeToFile(ByteBuffer buffer, long position) {//写入，因为没有并发写入可以只有一个文件通道而且不用枷锁
    ...
    public static synchronized void readAbBuf(ByteBuffer buffer, long position) {//读取
